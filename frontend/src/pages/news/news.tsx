  ...
  const newNewsSection = (
    ...
    >
      <TextField
        ...
        onChange={(event) =>
          setNews((prevNews) => ({ ...prevNews, title: event.target.value }))
        }
      />
      <TextField
        id="excerpt"
        label="Excerpt"
        value={newsValues.excerpt}
        onChange={(event) =>
          setNews((prevNews) => ({ ...prevNews, excerpt: event.target.value }))
        }
      />
      <TextField
        id="content"
        label="Title"
        value={newsValues.content}
        onChange={(event) =>
          setNews((prevNews) => ({ ...prevNews, content: event.target.value }))
        }
      />
      <TextField
        id="status"
        label="Status"
        value={newsValues.status}
        onChange={(event) =>
          setNews((prevNews) => ({ ...prevNews, status: event.target.value }))
        }
      />
